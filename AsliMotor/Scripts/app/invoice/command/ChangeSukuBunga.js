define([
    ...
    am.invoice.command.ChangeSukuBunga = Backbone.Model.extend({
    ...
    am.invoice.command.changeSukuBungaCommander = function (spec) {
        var that = {};
        var createCommand = function (model) {
            var changeSukuBungaCommand = new am.invoice.command.ChangeSukuBunga({
                InvoiceId: model.get("id"),
                SukuBunga: model.get('SukuBunga')
            });
            return changeSukuBungaCommand;
        }
