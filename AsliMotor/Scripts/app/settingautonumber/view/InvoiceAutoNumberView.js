define([
    ...
    am.settingautonumber.view.InvoiceAutoNumberView = Backbone.View.extend({
        initialize: function () {
        ...
        render: function () {
            ...
            var modeFormPanel = new HomeJS.components.FormPanel({
                ...
                class: "setting-invoice-auto-number",
        ...
        sendCommand: function () {
            ...
            if (check.isValid === false) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/settingautonumber/UpdateAutoNumberInvoice",
                    data: data,
                    dataType: "json",
    ...
    return am.settingautonumber.view.InvoiceAutoNumberView;
});