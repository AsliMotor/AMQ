define([
    ...
    am.settingautonumber.view.SuratPeringatanAutoNumberView = Backbone.View.extend({
        initialize: function () {
        ...
        render: function () {
            ...
            var modeFormPanel = new HomeJS.components.FormPanel({
                ...
                class: "setting-SuratPeringatan-auto-number",
        ...
        sendCommand: function () {
            ...
            if (check.isValid === false) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/settingautonumber/UpdateAutoNumberSuratPeringatan",
                    data: data,
                    dataType: "json",
    ...
    return am.settingautonumber.view.SuratPeringatanAutoNumberView;
});