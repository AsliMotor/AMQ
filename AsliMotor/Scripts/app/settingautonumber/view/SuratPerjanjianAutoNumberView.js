define([
    ...
    am.settingautonumber.view.SuratPerjanjianAutoNumberView = Backbone.View.extend({
        initialize: function () {
        ...
        render: function () {
            ...
            var modeFormPanel = new HomeJS.components.FormPanel({
                ...
                class: "setting-Perjanjian-auto-number",
        ...
        sendCommand: function () {
            ...
            if (check.isValid === false) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/settingautonumber/UpdateAutoNumberSuratPerjanjian",
                    data: data,
                    dataType: "json",
    ...
    return am.settingautonumber.view.SuratPerjanjianAutoNumberView;
});