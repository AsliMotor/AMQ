define([
    ...
    am.settingautonumber.model.SuratPeringatanAutoNumber = Backbone.Model.extend({
        url: '/settingautonumber/GetAutoNumberSuratPeringatan',
        defaults: {
            Prefix: ""
        },
        initialize: function () {
    ...
    return am.settingautonumber.model.SuratPeringatanAutoNumber;
});