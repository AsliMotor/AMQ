define([
    ...
    am.settingautonumber.model.InvoiceAutoNumber = Backbone.Model.extend({
        url: '/settingautonumber/GetAutoNumberInvoice',
        defaults: {
            Prefix: ""
        },
        initialize: function () {
    ...
    return am.settingautonumber.model.InvoiceAutoNumber;
});