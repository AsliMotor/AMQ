define([
    ...
    am.settingautonumber.model.SuratPerjanjianAutoNumber = Backbone.Model.extend({
        url: '/settingautonumber/GetAutoNumberSuratPerjanjian',
        defaults: {
            Prefix: ""
        },
        initialize: function () {
    ...
    return am.settingautonumber.model.SuratPerjanjianAutoNumber;
});