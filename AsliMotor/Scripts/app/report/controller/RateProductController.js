define(['jquery',
    ...
    function ($, _, Backbone, ns) {
        ...
        am.report.controller.RateProductController = function () {
            var rateProductReport = new am.report.model.RateProductReports();
            var breadcrumb = new HomeJS.components.Breadcrumb({
                title: 'Peringkat Penjualan Berdasarkan Kuantitas',
            ...
            var selectDateView = new am.report.view.SelectDateViewForRateProduct({
