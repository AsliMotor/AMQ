define(['jquery',
    ...
    function ($, _, Backbone, ns) {
        ...
        am.purchasereport.view.TableData = Backbone.View.extend({
            tagName: 'table',
            ...
            addHeader: function (header) {
                this.$el.find("thead tr").append(new am.purchasereport.view.TableData.TableHead({
            ...
            addItem: function (item) {
                if (item.get("Total") > 0) {
                    this.$el.find("tbody").append(new am.purchasereport.view.TableData.Row({
                        model: item,
        ...
        am.purchasereport.view.TableData.TableHead = Backbone.View.extend({
            tagName: "th",
            initialize: function () {
        ...
        am.purchasereport.view.TableData.Row = Backbone.View.extend({
            tagName: "tr",
            initialize: function () {
