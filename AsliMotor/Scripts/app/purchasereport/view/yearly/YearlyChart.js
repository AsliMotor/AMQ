define([
    ...
    ns.define("am.purchasereport.view.yearly");
    am.purchasereport.view.yearly.YearlyChart = Backbone.View.extend({
        initialize: function () {
        },
        render: function () {
            this.createChart();
                        ...
                        tooltip: {
                            formatter: function () {
                                return '<b>Total ' + this.series.name + '</b><br/>' +
            						Highcharts.dateFormat('%Y', this.x) + '<br/>Rp. ' + Highcharts.numberFormat(this.y);
                            }
                        },
                        exporting: {
                            enabled: true
