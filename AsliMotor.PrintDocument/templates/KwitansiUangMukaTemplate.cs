...
{
    public class KwitansiUangMukaTemplate
    {
        public const string DEFAULT = @"
            ...
            <div style='padding-top:30px'>
                <div style='padding-bottom:20px;text-align:center;font-weight:bold;font-size:18px;'>KWITANSI UANG MUKA PEMBELIAN</div>
                <div class='rowheight indent'>
                    <table>
                        <tr><td width='150px'>Nomor Transaksi</td><td width='20px'>:</td><td><b>$transactionNo$</b></td></tr>
